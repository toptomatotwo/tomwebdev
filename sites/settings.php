...
$databases = array(
	'default' =>
		array(
			'default' =>
			array(
				'database' => 'prosperity2016',
				'username' => 'tcarden',
				'password' => 'kingOfZanDa!e#77',
				'host' => 'localhost',
				'port' => '',
				'driver' => 'mysql',
				'prefix' => '',
...
/*
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_lexwebdev_local.inc'))
  require($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_lexwebdev_local.inc');
  */
//</DDSETTINGS>
