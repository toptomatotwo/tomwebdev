...
;(function($){
    ...
    woozy.define('scroll', function ($) {
        ...
        function scroll(el, offset){
            ...
            var end = el.offset().top - offset - 90;
    ...
    woozy.define('links', function ($, _) {
        ...
        function init() {
            ...
            var onePage = Drupal.settings.onePage;
            if(onePage == true) {
                $(".w-nav-menu li a,.dot-container a.dot-link").each(function(){
            ...
            var links = $(".w-nav-menu li a,.dot-container a.dot-link");
    ...
    woozy.define('navbar', function ($, _) {
        ...
        function init() {
            ...
            if(onePage == true) {
                $(".menu li a,.dot-container a.dot-link").each(function(){
                    var href = $(this).attr('href');
                    if(href.search("#") != -1) {
                        var newHref = href.replace(basePath,'');
                        $(this).attr('href',newHref);
    ...
    woozy.require('ix').init([
        ...
        /* MY EDIT THIS IS THE HEADER */ {"slug":"fade-down-12","name":"Fade Down 12","value":{"style":{"opacity":0,"x":"0px","y":"-15px"},"triggers":[{"type":"load","preload":true,"stepsA":[{"wait":1000},{"opacity":1,"transition":"transform 800ms ease 0ms, opacity 1000ms ease-in 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}},
